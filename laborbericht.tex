...
\section{Messwerte}
	...
	\begin{table}
		...
		\begin{tabular}{llllllllll}
			...
			\num{0} 	       	       	& $\SI{5,0}{\volt} 	    	& $\SI{10,0}{\volt} 	 	 & $\SI{15,0}{\volt}	      	      	       	       	&  &  & \num{160} 	      		& 0,2	      	      	       	& 0,38 	      	       	& 0,58 	       	       \\
			\num{10}	       	       	& $\SI{4,0}{\volt} 	    	& $\SI{8,17}{\volt} 	 	 & $\SI{12,16}{\volt} 	      	      	       		&  &  & \num{170} 	      		& 0,2 	      	       	& 0,31 	      	       	& 0,48 	       	       \\
			\num{20}	       	       	& $\SI{3,2}{\volt} 	    	& $\SI{6,54}{\volt} 	 	 & $\SI{9,85}{\volt} 	      	      	       		&  &  & \num{180} 	      		& 0,14 	      	       	& 0,26 	      	       	& 0,40 	       	       \\
			\num{30}	       	       	& $\SI{2,7}{\volt} 	    	& $\SI{5,30}{\volt} 	 	 & $\SI{7,99}{\volt}	      	      	       	       	&  &  & \num{190} 	      		& 0,12 	      	       	& 0,21 	      	       	& 0,33 	       	       \\
			\num{40}	       	       	& $\SI{2,92}{\volt}	    	& $\SI{4,34}{\volt} 	 	 & $\SI{6,54}{\volt}	      	      	       	       	&  &  & \num{200} 	      		& 0,1 	      	       	& 0,18 	      	       	& 0,27 	       	       \\
			\num{50}	       	       	& $\SI{1,6}{\volt} 	    	& $\SI{3,53}{\volt} 	 	 & $\SI{5,32}{\volt}	      	      	       	       	&  &  & \num{210} 	      		& 0,09 	      	       	& 0,15 	      	       	& 0,23 	       	       \\
			\num{60}	       	       	& $\SI{1,4}{\volt} 	    	& $\SI{2,86}{\volt} 	 	 & $\SI{4,32}{\volt}	      	      	       	       	&  &  & \num{220} 	      		& 0,073 	              	& 0,13 	      	       	& 0,19 	       	       \\
			\num{70}	       	       	& $\SI{1,2}{\volt} 	    	& $\SI{2,35}{\volt} 	 	 & $\SI{3,51}{\volt} 	      	     	       		&  &  & \num{230} 	      		& 0,06 	      	       	& 0,10 	      	       	& 0,164	       	       \\
			\num{80}	       	       	& $\SI{1,0}{\volt} 	    	& $\SI{1,89}{\volt} 	 	 & $\SI{2,86}{\volt} 	      	      	       		&  &  & \num{240} 	      		& 0,053 	              	& 0,088 	         	       	& 0,138	       	       \\
			\num{90}	       	       	& $\SI{0,8}{\volt} 	    	& $\SI{1,54}{\volt} 	 	 & $\SI{2,33}{\volt} 	      	      	       		&  &  & \num{250} 	      		& 0,045 	              	& 0,077 	         	       	& 0,115	       	       \\
			\num{100}	       	       	& $\SI{0,7}{\volt}		& $\SI{1,27}{\volt} 	 	 & $\SI{1,90}{\volt} 	      	      	       		&  &  & \num{260} 	      		& 0,04 	      	       	& 0,060 	         	       	& 0,100	       	       \\
			\num{110}	       	       	& $\SI{0,5}{\volt} 	    	& $\SI{1,04}{\volt} 	 	 & $\SI{1,56}{\volt} 	      	      	       		&  &  & \num{270} 	      		& 0,035 	              	& 0,055 	        	       	& 0,085	       	       \\
			\num{120}	       	       	& $\SI{0,4}{\volt} 	    	& $\SI{0,84}{\volt} 	 	 & $\SI{1,28}{\volt} 	      	      	       		&  &  & \num{280} 	      		& 0,032 	              	& 0,049 	        	       	& 0,073	       	       \\
			\num{130}	       	       	& $\SI{0,4}{\volt} 	    	& $\SI{0,70}{\volt} 	 	 & $\SI{1,05}{\volt} 	      	      	       		&  &  & \num{290} 	      		& 0,027 	              	& 0,04 	      	       	& 0,063	       	       \\
			\num{140}	       	       	& $\SI{0,3}{\volt} 	    	& $\SI{0,57}{\volt} 	 	 & $\SI{0,86}{\volt} 	      	      	       		&  &  & \num{300}	      		& 0,025 	                  & 0,037 	        	       	& 0,055	       	       \\
			\num{150}	       	       	& $\SI{0,3}{\volt} 	    	& $\SI{0,47}{\volt} 	 	 & $\SI{0,71}{\volt} 	      	      	       		&  &  & \num{310}	      		& 0,023 	              	& 0,033 	         	       	& 0,045	       	       \\ \cline{1-4} \cline{7-10}
		\end{tabular}
	...
	\begin{table}
		...
		\begin{tabular}{@{}ll@{}}
			...
			\num{240}			& $\SI{8,00}{\volt}	     	     \\
			\num{270}			& $\SI{7,78}{\volt}	     	     \\
			\num{300}			& $\SI{7,56}{\volt}	     	     \\ \bottomrule
		\end{tabular}
